...
export const CONFIG_JUEGO = {
  ...
  DINERO_INICIAL_CLIENTE: 1000,
  DINERO_INICIAL_JUGADOR: 500,
  RECARGA_BANCO: 100,
...
export const COLORES_JUGADORES = [
  {
    color: "#FF6B6B",
    colorFondo: "linear-gradient(135deg, #8B0000 0%, #B22222 50%, #CD5C5C 100%)",
    emoji: "🔴",
    nombre: "Rojo",
  },
  {
    color: "#4ECDC4",
    colorFondo: "linear-gradient(135deg, #004D40 0%, #00695C 50%, #00897B 100%)",
    emoji: "🟢",
    nombre: "Verde",
  },
  {
    color: "#45B7D1",
    colorFondo: "linear-gradient(135deg, #0D47A1 0%, #1565C0 50%, #1976D2 100%)",
    emoji: "🔵",
    nombre: "Azul",
  },
  {
    color: "#F7DC6F",
    colorFondo: "linear-gradient(135deg, #E65100 0%, #F57C00 50%, #FF9800 100%)",
    emoji: "🟡",
    nombre: "Amarillo",
  },
  {
    color: "#BB8FCE",
    colorFondo: "linear-gradient(135deg, #4A148C 0%, #6A1B9A 50%, #8E24AA 100%)",
    emoji: "🟣",
    nombre: "Morado",
  },
] as const;
